...
(function() {
	...
	angular.module('competencymatrixApp.competence', ['ngRoute','pascalprecht.translate']);
	angular.module('competencymatrixApp.competence').factory('competenceConnectorFactory', competenceConnectorFactory);
})();
