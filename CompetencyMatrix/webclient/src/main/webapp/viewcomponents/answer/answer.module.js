...
(function() {
	...
	angular.module('competencymatrixApp.answer', ['ngRoute','pascalprecht.translate']);
	angular.module('competencymatrixApp.answer').factory('answerConnectorFactory', answerConnectorFactory);
})();
