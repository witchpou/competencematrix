...
import de.starwit.competencymatrix.api.rest.response.EntityListResponse;
import de.starwit.competencymatrix.api.rest.response.EntityResponse;
import de.starwit.competencymatrix.api.rest.response.ResponseCode;
import de.starwit.competencymatrix.api.rest.response.ResponseMetadata;
import de.starwit.competencymatrix.api.rest.validation.EntityValidator;
import de.starwit.competencymatrix.ejb.AbstractService;
import de.starwit.competencymatrix.entity.AbstractEntity;
import de.starwit.competencymatrix.exception.EntityNotFoundException;
