...
import de.starwit.competencymatrix.config.ProjectConfig;
import de.starwit.competencymatrix.ejb.DataImportExportService;
		...
		try {
			...
			if (file.exists()) {
			    ...
			    while (tok.hasMoreTokens()) {
					...
					Class<? extends AbstractEntity> entityClass = (Class<? extends AbstractEntity>) Class.forName("de.starwit.competencymatrix.entity." + entityName);
